...
$( document ).ready(function() {
  ...
  if (!('webkitSpeechRecognition' in window)) {
    ...
    recognition.onresult = function(event) {
      ...
      if(event.results[event.results.length -1][0].transcript.trim() === "tell me a joke"){

        const utter = new SpeechSynthesisUtterance("Why don't eggs tell jokes? They'd crack each other up.");
        synth.speak(utter);
